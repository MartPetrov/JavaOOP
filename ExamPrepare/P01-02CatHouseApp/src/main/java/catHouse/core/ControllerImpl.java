...
public class ControllerImpl implements Controller {
    ...
    private House getHouseByName(String houseName) {
       return this.houses.stream().filter(house -> house.getName()
               .equals(houseName)).findFirst()
               .get();
    }
    ...
    public String feedingCat(String houseName) {
        House house = getHouseByName(houseName);
        int catsInHouse = house.getCats().size();
        house.feeding();
        return String.format(ConstantMessages.FEEDING_CAT, catsInHouse);
    }
